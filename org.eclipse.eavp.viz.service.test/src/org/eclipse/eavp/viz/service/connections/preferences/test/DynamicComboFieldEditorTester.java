...
import org.eclipse.eavp.viz.service.connections.preferences.DynamicComboFieldEditor;
...
public class DynamicComboFieldEditorTester {
	...
	public void checkValues() {
		...
		// Run everything on the UI thread to give access to a composite for the
		// editor
