...
public class CSVSeries extends TransformedList<Double, Double>
	...
	/**
	 * The constructor for the list of values.
	 * 
	 * @param source
	 *            The list of values that define the series.
	 */
	public CSVSeries(EventList<Double> source) {
		super(source);
		time = 0;
		parent = null;
	 ...
	 * 
	 * @see
	 * ca.odell.glazedlists.TransformedList#listChanged(ca.odell.glazedlists.
	 * event.ListEvent)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.eclipse.eavp.viz.service.ISeries#setStyle(org.eclipse.eavp.viz.
	 * service.ISeriesStyle)
	 */
	@Override
