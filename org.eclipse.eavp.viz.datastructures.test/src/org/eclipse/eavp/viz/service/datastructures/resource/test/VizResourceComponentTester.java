...
public class VizResourceComponentTester {
	...
	public void checkResources() {
		...
		// lived
		try {
			resources.add(new VisualizationResource(
					new File("Mississippi.testFile")));
			resources.add(
					new VisualizationResource(new File("Enterprise.testFile")));
			resources.add(new VisualizationResource(
					new File("EnterpriseA.testFile")));
			resources.add(
					new VisualizationResource(new File("DramiaII.testFile")));
			resources.add(
					new VisualizationResource(new File("CapellaIV.testFile")));
		} catch (IOException e) {
			e.printStackTrace();
			fail();
		}
	...
	public void checkNotifications() {
		...
		try {
			resourceComponent.addResource(
					new VisualizationResource(new File("SickBay.testFile")));
		...
		try {
			resourceComponent.addResource(new VisualizationResource(
					new File("ShoreLeavePlanet.testFile")));
		} catch (IOException e1) {
			e1.printStackTrace();
			fail();
		}
	...
	public void checkEquality() {
		...
		try {
			outComp1.addResource(
					new VisualizationResource(new File("TestFile.test")));
			outComp1.addResource(
					new VisualizationResource(new File("SecondTestFile.test")));

			// Add equal files to equalComp
			equalComp.addResource(
					new VisualizationResource(new File("TestFile.test")));
			equalComp.addResource(
					new VisualizationResource(new File("SecondTestFile.test")));
			...
			unEqual.addResource(
					new VisualizationResource(new File("OtherFile.test")));
			unEqual.addResource(
					new VisualizationResource(new File("HelloFile.file")));

			// Create equal File for transitive test
			transitiveComp.addResource(
					new VisualizationResource(new File("TestFile.test")));
			transitiveComp.addResource(
					new VisualizationResource(new File("SecondTestFile.test")));
	...
	public void checkCloning() {
		...
		// Run clone operation
		VizResourceComponent cloneOutput = (VizResourceComponent) resourceComponent
				.clone();
	...
	public void checkXMLPersistence()
		...
		testRC2 = (VizResourceComponent) xmlHandler.read(classList,
				inputStream);
