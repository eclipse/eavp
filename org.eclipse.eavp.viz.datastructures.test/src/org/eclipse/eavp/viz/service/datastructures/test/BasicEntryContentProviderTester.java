...
public class BasicEntryContentProviderTester {
	...
	public void checkEquality() {
		// Local Declarations
		BasicVizEntryContentProvider contentProvider, equalContentProvider,
				unEqualContentProvider, transitiveContentProvider = null;
		...
		equalContentProvider
				.setAllowedValueType(VizAllowedValueType.Continuous);
		unEqualContentProvider
		...
		assertTrue(
				contentProvider.equals(equalContentProvider) && contentProvider
						.hashCode() == equalContentProvider.hashCode());
	...
	public void checkCopying() {
		// Local Declarations
		BasicVizEntryContentProvider contentProvider, contentProviderCopy,
				contentProviderClone = null;
		ArrayList<String> allowedValues = new ArrayList<String>();
	...
	public void checkXMLPersistence()
		...
		loadedProvider = (BasicVizEntryContentProvider) xmlHandler
