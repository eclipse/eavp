 ...
 *   
 *******************************************************************************/
package org.eclipse.eavp.tests.viz.service.paraview.proxy;
...
import org.eclipse.eavp.tests.viz.service.paraview.TestUtils;
...
import org.eclipse.eavp.viz.service.paraview.proxy.vtk.VtkProxy;
import org.eclipse.eavp.viz.service.paraview.proxy.vtk.VtkProxyBuilder;
import org.junit.After;
import org.junit.Before;
import org.junit.Test;

/**
 * This class tests the {@link VtkProxyBuilder}'s implementation of
 * {@link IParaViewProxyBuilder}.
 * 
 * @author Jordan Deyton, Robert Smith
 *
 */
public class VtkProxyBuilderTester {

	/**
	 * The proxy builder that will be tested. This is re-initialized before each
	 * test.
	 */
	private VtkProxyBuilder proxyBuilder;
	...
	public void beforeEachTest() {
		proxyBuilder = new VtkProxyBuilder();
	}
	...
	public void checkName() {
		assertEquals("Default Vtk Proxy Builder", proxyBuilder.getName());
	}
	...
	public void checkExtensions() {
		...
		String[] extensions = new String[] { "vtk", "vts" };
	...
	public void checkProxy() {
		...
		for (String extension : proxyBuilder.getExtensions()) {
			...
			assertTrue(proxy instanceof VtkProxy);
