...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>Mesh Cache</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following operations are tested:
 * <ul>
 *   <li>{@link model.MeshCache#getMesh(java.lang.String) <em>Get Mesh</em>}</li>
 *   <li>{@link model.MeshCache#getMesh(org.eclipse.emf.common.util.EList) <em>Get Mesh</em>}</li>
 * </ul>
 * </p>
 * @generated
 */
public class MeshCacheTest extends TestCase {
	...
	/**
	 * The fixture for this Mesh Cache test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Sets the fixture for this Mesh Cache test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Returns the fixture for this Mesh Cache test case.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Tests the '{@link model.MeshCache#getMesh(java.lang.String) <em>Get Mesh</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see model.MeshCache#getMesh(java.lang.String)
	 * @generated NOT
	 */
	public void testGetMesh__String() {
		
		//The cache for testing
		TestCache cache = new TestCache();
		
		//The cache should return null when the requested type is not recognized
		...
		//Check that the cache will return not just an identical value but the same data object.
		assertTrue(cache.getMesh("test1") == cache.getMesh("test1"));
	}

	/**
	 * Tests the '{@link model.MeshCache#getMesh(org.eclipse.emf.common.util.EList) <em>Get Mesh</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void testGetMesh__EList() {
		...
		//The mesh should always return references to the same mesh for the same input
		assertTrue(cache.getMesh(list2) == cache.getMesh(list2));
		
		//Check that the correct mesh is returned for two different lists with identical values
