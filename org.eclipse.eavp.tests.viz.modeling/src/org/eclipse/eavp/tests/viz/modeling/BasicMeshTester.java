...
import org.eclipse.eavp.tests.viz.service.datastructures.VizObject.TestManagedListener;
...
public class BasicMeshTester {
	...
	public void testEntityCategories() {
		...
		assertEquals(2, component.getEntitiesFromCategory(MeshCategory.VERTICES)
				.size());
	...
	public void testEquality() {
		...
		BasicController child = new BasicController(equalMesh, new BasicView());
