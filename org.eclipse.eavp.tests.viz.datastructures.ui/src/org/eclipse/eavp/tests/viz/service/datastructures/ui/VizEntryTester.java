...
public class VizEntryTester {
	...
	/**
	 * This operation tests the VizEntry by creating an VizEntry using the
	 * simple constructor. It checks that the name and ID are set to proper
	 * values while all remaining values are set to the defaults values for an
	 * VizEntry. It also checks the ability of the VizEntry to report whether or
	 * not it is secret.
	 */
	@Test
	...
	public void checkReadiness() {
		...
		// Tell the VizEntry that it shouldn't be ready and make sure it
		// updated.
	...
	public void checkValue() {
		...
		// Create the full entry, allowedValueType =
		// VizAllowedValueType.Discrete
		entry = new VizEntry() {
		...
		// Check that setup is not run when the constructor specifies that it
		// should be skipped
		...
		// Check if setup() changed entry's value type from the default
		// Undefined.
	...
	/**
	 * This operation checks the changed state of the VizEntry by first setting
	 * the value of the VizEntry and then making sure that isModified() returns
	 * true.
	 */
	@Test
	...
	/**
	 * This operation checks the VizEntry class to insure that its copy
	 * operation works.
	 */
	@Test
	...
	/**
	 * This operation checks the ability of the VizEntry to persist itself to
	...
	public void checkContentProviderConstructor() {
		...
		assertEquals(contentProvider.getParent(),
				overriddenVizEntry.getParent());
		assertEquals("", overriddenVizEntry.getValue()); // Resets value to
															// empty!
