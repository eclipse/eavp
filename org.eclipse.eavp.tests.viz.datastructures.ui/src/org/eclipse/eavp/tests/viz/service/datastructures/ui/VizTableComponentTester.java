...
public class VizTableComponentTester {
	...
	/**
	 * <p>
	 * An IComponentListener used to test notifications from the
	 * VizTableComponent.
	 * </p>
	 * 
	 */
	...
	public void checkConstruction() {
		...
		// check column names
		assertEquals(testColumn1.getName(),
				tableComponent.getColumnNames().get(0));
		assertEquals(testColumn2.getName(),
				tableComponent.getColumnNames().get(1));
		assertEquals(testColumn3.getName(),
				tableComponent.getColumnNames().get(2));
	...
	public void checkRowManipulation() {
		...
		assertEquals("Bill",
				tableComponent.getRow(rowIds.get(0)).get(0).getName());
		assertEquals("Bob",
				tableComponent.getRow(rowIds.get(1)).get(0).getName());
	...
	/**
	 * <p>
	 * This operation checks the VizTableComponent to insure that its equals()
	...
	/**
	 * This operation checks the ability of the VizTableComponent to persist
	...
	public void checkLoadingFromXML()
		...
		/*
		 * The following sets of operations will be used to test the
		 * "read and write" portion of the VizTableComponent. It will
		...
		tableComponent2 = (VizTableComponent) xmlHandler.read(classList,
				inputStream);
