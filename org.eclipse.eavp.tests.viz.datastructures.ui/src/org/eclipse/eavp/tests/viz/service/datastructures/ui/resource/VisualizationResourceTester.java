...
/**
 * * This class is responsible for checking the VizResource class * * @author
 * Taylor Patterson *
 */
public class VisualizationResourceTester {
	...
	/**
	 * <p>
	 * This operation checks the construction of an ICEResource to insure that
	 * it can be created from both a java.io.File.
	 * </p>
	 * 
	 */
	@Test
	...
	public void checkXMLPersistence()
		...
		vizResource = new VisualizationResource(new File(filename),
				childResources);
		...
		loadedResource = (VisualizationResource) xmlHandler.read(classList,
				inputStream);
	...
	public void checkEquality() throws IOException {
		...
		equalResource = new VisualizationResource(new File(filename),
				childResources);
	...
	public void checkCopying() throws IOException {
		...
		// Local declarations
		VisualizationResource vizResource = null,
				equalResource = new VisualizationResource();
		VisualizationResource childRes1 = new VisualizationResource(),
				childRes2 = new VisualizationResource();
		ArrayList<IVizResource> childResources = new ArrayList<IVizResource>();
		childResources.add(childRes1);
