...
import org.eclipse.eavp.viz.datastructures.ui.DataComponent;
...
public class VizDataComponentTester {
	...
	public void checkCopying() {
		...
		// check Contents
		assertEquals(dataComponent.getDescription(),
				cloneData.getDescription());
	...
	public void checkLoadingFromXML()
		...
		loadDataComponent = (DataComponent) xmlHandler.read(classList,
				inputStream);
