 ...
 *******************************************************************************/
package org.eclipse.eavp.tests.viz.service.datastructures.VizObject;
 ...
 * ICEJAXBHandler to ensure that it can read and write to the streams properly.
 * It used the SimpleJAXBTestClass.
 * </p>
 * 
...
public class VizJAXBHandlerTester {
	 ...
	 * write to the streams properly. It used the SimpleJAXBTestClass.
	 * </p>
	 * 
	 */
	@Test
	public void checkXMLPersistence() {
		...
		try {
			data = iCEJAXBManipulator.read(classList, inputStream);
		...
		try {
			iCEJAXBManipulator.write(simpleJAXBTestClass, classList,
					outputStream);
		} catch (NullPointerException e) {
			e.printStackTrace();
			fail();
	 ...
	 * Class parameter is passed. The testing method should throw a
	 ...
	 * <p>
	 * This test checks the behavior ICEJAXBHandler.read() operation when a null
	 * inputStream parameter is passed. The testing method should throw a
	 * NullPointerException.
	 * </p>
	 * 
	 * @throws IOException
	 ...
	 */
	@Test(expected = javax.xml.bind.JAXBException.class)
	public void checkXMLPersistenceReadWithInvalidObject()
			throws IOException, JAXBException, NullPointerException {
	 ...
	 */
	@Test(expected = javax.xml.bind.JAXBException.class)
	public void checkXMLPersistenceWriteWithInvalidObject()
			throws IOException, JAXBException, NullPointerException {
		// This test will demonstrate the reaction of JAXB marshallers on a
