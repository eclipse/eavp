...
public class ScatterSeriesSecondaryAxesPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	public ScatterSeriesSecondaryAxesPreferencePage() {
		super(GRID);
