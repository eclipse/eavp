...
public class BarSeriesPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		preferenceStore.setDefault(BarSeriesPreferenceConstants.P_SECONDARY_X_AXIS_TITLE, BarSeriesPreferenceConstants.DEF_SECONDARY_X_AXIS_TITLE);
		preferenceStore.setDefault(BarSeriesPreferenceConstants.P_SECONDARY_X_AXIS_DESCRIPTION, BarSeriesPreferenceConstants.DEF_SECONDARY_X_AXIS_DESCRIPTION);
		preferenceStore.setDefault(BarSeriesPreferenceConstants.P_SECONDARY_X_AXIS_DECIMAL_FORMAT_PATTERN, BarSeriesPreferenceConstants.DEF_SECONDARY_X_AXIS_DECIMAL_FORMAT_PATTERN);
		preferenceStore.setDefault(BarSeriesPreferenceConstants.P_SECONDARY_X_AXIS_DECIMAL_FORMAT_LOCALE, BarSeriesPreferenceConstants.DEF_SECONDARY_X_AXIS_DECIMAL_FORMAT_LOCALE);
		preferenceStore.setDefault(BarSeriesPreferenceConstants.P_SECONDARY_X_AXIS_COLOR, BarSeriesPreferenceConstants.DEF_SECONDARY_X_AXIS_COLOR);
		preferenceStore.setDefault(BarSeriesPreferenceConstants.P_SECONDARY_X_AXIS_POSITION, BarSeriesPreferenceConstants.DEF_SECONDARY_X_AXIS_POSITION);
		preferenceStore.setDefault(BarSeriesPreferenceConstants.P_SECONDARY_X_AXIS_VISIBLE, BarSeriesPreferenceConstants.DEF_SECONDARY_X_AXIS_VISIBLE);
		preferenceStore.setDefault(BarSeriesPreferenceConstants.P_SECONDARY_X_AXIS_GRID_LINE_STYLE, BarSeriesPreferenceConstants.DEF_SECONDARY_X_AXIS_GRID_LINE_STYLE);
		preferenceStore.setDefault(BarSeriesPreferenceConstants.P_SECONDARY_X_AXIS_ENABLE_LOG_SCALE, BarSeriesPreferenceConstants.DEF_SECONDARY_X_AXIS_ENABLE_LOG_SCALE);
