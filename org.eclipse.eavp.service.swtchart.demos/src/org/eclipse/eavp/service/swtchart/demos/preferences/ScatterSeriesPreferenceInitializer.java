...
public class ScatterSeriesPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_SHOW_CENTER_MARKER, ScatterSeriesPreferenceConstants.DEF_SHOW_CENTER_MARKER);
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_COLOR_CENTER_MARKER, ScatterSeriesPreferenceConstants.DEF_COLOR_CENTER_MARKER);
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_SHOW_POSITION_LEGEND, ScatterSeriesPreferenceConstants.DEF_SHOW_POSITION_LEGEND);
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_COLOR_POSITION_LEGEND, ScatterSeriesPreferenceConstants.DEF_COLOR_POSITION_LEGEND);
		...
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_PRIMARY_X_AXIS_MARGIN_TITLE, ScatterSeriesPreferenceConstants.DEF_PRIMARY_X_AXIS_MARGIN_TITLE);
		...
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_PRIMARY_Y_AXIS_MARGIN_TITLE, ScatterSeriesPreferenceConstants.DEF_PRIMARY_Y_AXIS_MARGIN_TITLE);
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_DESCRIPTION_SERIES_1, ScatterSeriesPreferenceConstants.DEF_DESCRIPTION_SERIES_1);
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_SYMBOL_COLOR_SERIES_1, ScatterSeriesPreferenceConstants.DEF_SYMBOL_COLOR_SERIES_1);
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_SYMBOL_SIZE_SERIES_1, ScatterSeriesPreferenceConstants.DEF_SYMBOL_SIZE_SERIES_1);
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_SYMBOL_TYPE_SERIES_1, ScatterSeriesPreferenceConstants.DEF_SYMBOL_TYPE_SERIES_1);
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_VISIBLE_SERIES_1, ScatterSeriesPreferenceConstants.DEF_VISIBLE_SERIES_1);
		preferenceStore.setDefault(ScatterSeriesPreferenceConstants.P_VISIBLE_IN_LEGEND_SERIES_1, ScatterSeriesPreferenceConstants.DEF_VISIBLE_IN_LEGEND_SERIES_1);
	}
}
