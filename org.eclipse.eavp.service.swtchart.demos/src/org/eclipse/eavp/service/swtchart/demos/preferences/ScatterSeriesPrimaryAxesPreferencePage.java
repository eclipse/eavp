...
public class ScatterSeriesPrimaryAxesPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
	...
	public void createFieldEditors() {
		...
		addField(new IntegerFieldEditor(ScatterSeriesPreferenceConstants.P_PRIMARY_X_AXIS_MARGIN_TITLE, "Primary X-Axis Margin Title:", getFieldEditorParent()));
		//
		addField(new SpacerFieldEditor(getFieldEditorParent()));
		...
		addField(new IntegerFieldEditor(ScatterSeriesPreferenceConstants.P_PRIMARY_Y_AXIS_MARGIN_TITLE, "Primary Y-Axis Margin Title:", getFieldEditorParent()));
	}
