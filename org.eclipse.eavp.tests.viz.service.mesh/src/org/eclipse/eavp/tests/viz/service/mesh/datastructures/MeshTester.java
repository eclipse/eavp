 ...
 *******************************************************************************/
package org.eclipse.eavp.tests.viz.service.mesh.datastructures;
...
public class MeshTester {
	...
	public void checkMesh() {
		...
		// Move the vertex.
		vertex = edges.get(0).getEntitiesFromCategory(MeshCategory.VERTICES,
				VertexController.class).get(0);
