...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>STL Geometry Importer</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class STLGeometryImporterTest extends TestCase {
	...
	/**
	 * The error allowed by the parser when reading and converting doubles
	 * @generated NOT
	 */
	private final double parseError = 0.0;
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see junit.framework.TestCase#tearDown() xtext.services,
 xtext.serializer,
 xtext.parser.antlr,
 xtext.parser.antlr.internal,
	...
	public void testLoad__Path() {
		Path asciiSTL = FileSystems.getDefault().getPath("src", "geometry", "tests", "resources", "asciiExample.stl");	
		Geometry stlGeom = fixture.load(asciiSTL);
		
		testGeometry(stlGeom);
		
		
		Path binarySTL = FileSystems.getDefault().getPath("src", "geometry", "tests", "resources", "binaryExample.stl");
	...
	private void testVertex(Vertex v, double x, double y, double z) {
		assertEquals(x, v.getX(), parseError);
		assertEquals(y, v.getY(), parseError);
		assertEquals(z, v.getZ(), parseError);
	}
