...
import org.eclipse.eavp.viz.service.rcp.connection.RCPConnectionVizService;
 ...
 * {@link RCPConnectionVizService}.
 * 
 * @author Jordan Deyton, Robert Smith
 *
 */
public class RCPConnectionVizServiceTester {
	 ...
	 */
	private RCPConnectionVizService<FakeClient> service;
	...
	public void beforeEachTest() {
		...
		service = new RCPConnectionVizService<FakeClient>() {
			...
			@Override
			protected RCPConnectionManager<FakeClient> createConnectionManager() {
				return new RCPConnectionManager<FakeClient>() {
					@Override
