...
package org.eclipse.eavp.tests.viz.service.rcp.csv;
...
import org.eclipse.eavp.viz.service.rcp.csv.series.XYZSeries;
import org.eclipse.swt.graphics.Color;
import org.junit.Test;

/**
 * This class is responsible for testing the XYZSeries class. It tests both the
 ...
 *
 */
public class XYZSeriesTester {

	@Test
	public void testRCPCSVSeries() {
		// Test that the series was constructed correctly with logical default
		// values
		XYZSeries series = new XYZSeries(new Color(null, 0, 0, 0));
	...
	public void testHashCode() {
		...
		XYZSeries series2 = getSeries("test");
	...
	public void testGetDataPoints() {
		...
		XYZSeries series = getSeries("test");
		...
		series = new XYZSeries(new Color(null, 0, 0, 0));
	...
	public void testGetParentSeries() {
		...
		XYZSeries series = new XYZSeries(new Color(null, 0, 0, 0));
		XYZSeries parent = new XYZSeries(new Color(null, 0, 0, 0));
	...
	public void testGetStyle() {
		...
		XYZSeries series = getSeries("stylin");
	...
	public void testEqualsObject() {
		...
		XYZSeries series1 = getSeries("one");
		XYZSeries series2 = getSeries("two");
		XYZSeries series3 = getSeries("one");
	 ...
	 *         set
	 */
	private XYZSeries getSeries(String lbl) {
