 ...
 * </p>
 * <ul>
 *   <li>{@link model.ScaleDecorator#getScale <em>Scale</em>}</li>
 * </ul>
 *
 * @see model.ModelPackage#getScaleDecorator()
 * @model
 * @generated
 */
public interface ScaleDecorator<T> extends RenderObjectDecorator<T> {
	 ...
	 * @see #setScale(double)
	 * @see model.ModelPackage#getScaleDecorator_Scale()
	 * @model default="1"
	 * @generated
	 */
	double getScale();
	...
	/**
	 * Sets the value of the '{@link model.ScaleDecorator#getScale <em>Scale</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
