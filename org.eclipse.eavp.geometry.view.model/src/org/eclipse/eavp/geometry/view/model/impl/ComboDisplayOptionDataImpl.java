 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.eavp.geometry.view.model.impl.ComboDisplayOptionDataImpl#getDisplayOption
 * <em>Display Option</em>}</li>
 * <li>{@link org.eclipse.eavp.geometry.view.model.impl.ComboDisplayOptionDataImpl#getTextToPropertyValuesMap
 * <em>Text To Property Values Map</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComboDisplayOptionDataImpl extends MinimalEObjectImpl.Container
	...
	/**
	 * The cached value of the '{@link #getTextToPropertyValuesMap() <em>Text To
	 * Property Values Map</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
			...
			if (displayOption != oldDisplayOption) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModelPackage.COMBO_DISPLAY_OPTION_DATA__DISPLAY_OPTION,
	...
	public void setTextToPropertyValuesMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModelPackage.COMBO_DISPLAY_OPTION_DATA__TEXT_TO_PROPERTY_VALUES_MAP,
					oldTextToPropertyValuesMap, textToPropertyValuesMap));
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ModelPackage.COMBO_DISPLAY_OPTION_DATA__DISPLAY_OPTION:
			...
			return;
		case ModelPackage.COMBO_DISPLAY_OPTION_DATA__TEXT_TO_PROPERTY_VALUES_MAP:
			setTextToPropertyValuesMap(
					(Map<String, Map<String, Object>>) newValue);
			return;
		}
