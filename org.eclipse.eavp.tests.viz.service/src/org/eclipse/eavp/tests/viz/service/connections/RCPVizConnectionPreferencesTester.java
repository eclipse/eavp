...
/**
 * A class to test the RCPVizConnectionPreferences for the ability to correctly
 * manage a set of preferences through the IRemoteConnectionManager.
 * 
 * @author Robert Smith
 *
 */
public class RCPVizConnectionPreferencesTester {
	...
	public void checkConstruction() {
		RCPVizConnectionPreferences prefs = new RCPVizConnectionPreferences() {

		};

		// Check that the null constructor correctly initializes the
		// preferences.
		assertEquals("localhost", prefs.getConnectionName());
	}
	...
	public void checkSerialize() {
		...
		TestRCPVizConnectionPreferences prefs = new TestRCPVizConnectionPreferences(
				context);
		...
		assertEquals(
				"ADDRESS_ATTR,Test Connection,1234,USERNAME_ATTR,Remote Connection",
				serialized);
	...
	/**
	 * An extension of RCPVizConnectionPreferences which allows a custom
	 * BundleContext to be set to the class for testing purposes.
	 * 
	 * @author Robert Smith
	 *
	 */
	private class TestRCPVizConnectionPreferences
		 ...
		 */
		public TestRCPVizConnectionPreferences(BundleContext context) {
			super();
		 ...
		 *            IRemoteServicesManager.
		 */
		public TestRCPVizConnectionPreferences(String data,
